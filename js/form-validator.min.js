  ...
  (d.DEFAULTS = {
    ...
    (d.prototype.validateInput = function (b) {
      ...
      if (
        ...
        this.$element.trigger((b = a.Event('validate.bs.validator', { relatedTarget: c[0] }))),
        ...
        this.runValidators(c).done(function (f) {
          c.data('bs.validator.errors', f),
            ...
            (d && f.toString() === d.toString()) ||
              ((b = f.length
                ? a.Event('invalid.bs.validator', { relatedTarget: c[0], detail: f })
                : a.Event('valid.bs.validator', { relatedTarget: c[0], detail: d })),
              e.$element.trigger(b)),
            e.toggleSubmit(),
    ...
    (d.prototype.validate = function () {
      ...
      return (
        (this.options.delay = 0), this.$element.find(c).trigger('input.bs.validator'), (this.options.delay = a), this
      );
    }),
